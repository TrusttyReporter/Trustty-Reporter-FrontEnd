...
celery = Celery(__name__,
                broker= f"{os.environ.get('REDIS_URL')}?ssl_cert_reqs=CERT_NONE", 
                backend=f"{os.environ.get('REDIS_URL')}?ssl_cert_reqs=CERT_NONE"
                )
...
def create_app(config_name):
    ...
    app.config["SSE_REDIS_URL"] = os.environ.get('REDIS_URL')
